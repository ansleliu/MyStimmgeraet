#ifndef FFT_N
#define FFT_N	2048	/* Number of samples (64,128,256,512,2048). Don't forget to clean! */
//#define INPUT_NOUSE
//#define INPUT_IQ
...
#ifndef INPUT_NOUSE
#ifdef INPUT_IQ
void fft_input (volatile const complex_t *, volatile complex_t *);
#else
void fft_input (volatile const int16_t *, volatile complex_t *);
#endif
#endif
void fft_execute (volatile complex_t *);
void fft_output (volatile complex_t *, volatile uint16_t *);
